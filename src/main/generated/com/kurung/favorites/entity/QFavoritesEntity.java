...
public class QFavoritesEntity extends EntityPathBase<FavoritesEntity> {
    ...
    public final com.kurung.diet.entity.QFoodEntity foods;
    ...
    public QFavoritesEntity(Class<? extends FavoritesEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foods = inits.isInitialized("foods") ? new com.kurung.diet.entity.QFoodEntity(forProperty("foods"), inits.get("foods")) : null;
