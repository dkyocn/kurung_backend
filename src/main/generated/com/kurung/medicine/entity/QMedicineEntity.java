...
public class QMedicineEntity extends EntityPathBase<MedicineEntity> {
    ...
    public final ListPath<InputMedicineEntity, QInputMedicineEntity> inputMedicine1 = this.<InputMedicineEntity, QInputMedicineEntity>createList("inputMedicine1", InputMedicineEntity.class, QInputMedicineEntity.class, PathInits.DIRECT2);

    public final ListPath<InputMedicineEntity, QInputMedicineEntity> inputMedicine2 = this.<InputMedicineEntity, QInputMedicineEntity>createList("inputMedicine2", InputMedicineEntity.class, QInputMedicineEntity.class, PathInits.DIRECT2);
