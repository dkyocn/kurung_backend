...
public class QInputMedicineEntity extends EntityPathBase<InputMedicineEntity> {
    ...
    public final QMedicineEntity medicine1;

    public final QMedicineEntity medicine2;
    ...
    public QInputMedicineEntity(Class<? extends InputMedicineEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.medicine1 = inits.isInitialized("medicine1") ? new QMedicineEntity(forProperty("medicine1")) : null;
        this.medicine2 = inits.isInitialized("medicine2") ? new QMedicineEntity(forProperty("medicine2")) : null;
