...
public class QObjectiveEntity extends EntityPathBase<ObjectiveEntity> {
    ...
    public final DatePath<java.sql.Date> lastUpdatedAt = createDate("lastUpdatedAt", java.sql.Date.class);
    ...
    public final NumberPath<java.math.BigDecimal> objectiveWeight = createNumber("objectiveWeight", java.math.BigDecimal.class);
