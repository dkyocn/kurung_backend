...
public class QExerciseEntity extends EntityPathBase<ExerciseEntity> {
    ...
    public final ListPath<ExerciseLogEntity, QExerciseLogEntity> exerciseLogs = this.<ExerciseLogEntity, QExerciseLogEntity>createList("exerciseLogs", ExerciseLogEntity.class, QExerciseLogEntity.class, PathInits.DIRECT2);
