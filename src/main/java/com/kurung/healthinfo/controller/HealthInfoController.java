...
//  }
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "573", description = "수정 실패", content = @Content(mediaType = "application/json"))
  })
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "574", description = "저장 실패", content = @Content(mediaType = "application/json"))
  })
