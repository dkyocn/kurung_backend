        ...
        mockMvc.perform(RestDocumentationRequestBuilders.get("/api/v1/kurung/diet/{id}",1))
                ...
                .andDo(document("getDietById",
                        ...
                        relaxedResponseFields(
                                ...
                                fieldWithPath("foodList[].foodName").description("음식 이름").type(JsonFieldType.STRING),
                                fieldWithPath("foodList[].foodPhoto").description("음식 사진").type(JsonFieldType.STRING),
                                ...
                                fieldWithPath("user.userFaceLoginYN").description("페이스 로그인 등록 여부").type(JsonFieldType.BOOLEAN),
